...
df = pickle.load(open('X_test.pkl', 'rb'))

st.title('Linear Regression Assignment')
st.info('It is expected to predict boston house price median value in the selected region using Linear Regression algorithms. '
